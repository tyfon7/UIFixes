...
//         {
//             return AccessTools.DeclaredProperty(typeof(InventoryInteractions), nameof(InventoryInteractions.AvailableInteractions)).GetMethod;
//         }
...
//             RagfairOfferSellHelperClass ragfairHelper = new(session.Profile.Inventory.Stash.Grid, );
